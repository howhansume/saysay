...
@synthesize SIDCREATED, SIDUPDATED, SIDDELETED, PROFILENICKNAME, CHANGEDATE, CHANGEDATE2, REPRESENTPHOTOSP, NICKNAMESP, STATUSSP;
...
{
	@synchronized(self) {
		UserInfo *data = [[self class] allocWithZone:zone];
		if (data) {
