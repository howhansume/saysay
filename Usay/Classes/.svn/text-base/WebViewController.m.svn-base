...
//	self.title = [self strTitle];
	...
	if (url) {
		...
		DebugLog(@"nsurl = %@", nsurl);
		//임시..
		//nsurl = [NSURL URLWithString:@"http://dev.usay.net/mobile/01.html?pKey=f2f22638-f144-11df-8161-85ffd2fe38b2&svcidx=ucmbip"];
		...
		if (nsurl) {
			if(webView) {
				...
				/*
				NSError *netErr;
				NSString *tmp = [NSString stringWithContentsOfURL:[NSURL URLWithString:nsurl]
