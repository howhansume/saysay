...
@interface UsayAddressViewController : UITableViewController<UIActionSheetDelegate, UIScrollViewDelegate, editAddressDelegate,
...
@property (nonatomic, retain) NSMutableArray* usayDataArray;
