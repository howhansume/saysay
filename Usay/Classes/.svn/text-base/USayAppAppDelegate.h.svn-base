...
#import "CrashReportSender.h"			// sochae 2010.11.17 - crash report
...
/**
 @brief USayAppAppDelegate: Usay 메인 Delegate 인터페이스
 */
@interface USayAppAppDelegate : NSObject <UIApplicationDelegate, CrashReportSenderDelegate> {
    UIWindow					*window;
...
//	CertificationViewController *authViewController;
	...
	NSMutableDictionary			*postBodyObject;
	...
	//메모리 추가 2011.03.22
	NSMutableArray				*GroupArray;		//새로운 그룹 정보
	NSMutableArray				*tmpGroupArray;		//새로운 그룹 정보
	
	NSMutableArray				*UsayGrupArray;		//새로운 그룹 정보
	NSMutableArray				*tmpUsayGroupArray;		//새로운 그룹 정보

	
	NSMutableArray				*allRecord; //레코드 번호당 하나씩 가지고 있는 배열
	NSThread					*Thread;
	NSMutableArray				*alterGroupArray; //변경된 데이터만 가지고 있는 배열
	NSMutableDictionary			*findRecordIndexDic; //해당 레코드 번호가 어느 그룹에 몇번째 배열에 속해 있는지 찾기 위한 변수
	
	NSMutableDictionary			*userAllDataDic;
	BOOL	LoadingData;
	struct st_sendcnt {
		int start;
		int count;
...
// 세션별 새 메시지 총 개수 가져오기 (현재 duplication시에만 사용)
...
@property (nonatomic, retain) NSMutableDictionary				*postBodyObject;
...
@property (nonatomic, retain) NSMutableArray				*tmpGroupArray;
@property (nonatomic, retain) NSMutableArray				*UsayGroupArray;
@property (nonatomic, retain) NSMutableArray				*tmpUsayGroupArray;
@property (nonatomic, retain) NSMutableDictionary			*userAllDataDic;


@property (nonatomic, retain) NSMutableArray				*allRecord;
@property (nonatomic, retain) NSThread                      *Thread;
@property (nonatomic, retain) NSMutableArray				*alterGroupArray;
@property (nonatomic, retain) NSMutableDictionary			*findRecordIndexDic;
...
@property (readwrite) BOOL								LoadingData;
