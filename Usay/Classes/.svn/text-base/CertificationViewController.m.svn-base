...
-(void) sendNumber {
	...
	NSDictionary *bodyObject = [NSDictionary dictionaryWithObjectsAndKeys:
		...
		//						national.titleLabel.text, @"national",
		//						nationalCode.titleLabel.text, @"nationalcode",
...
//	DebugLog(@"  ===> [plist] CertificationStatus : %d ", authState);
...
//20101024	UIView* customHeaderView = [[[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 35)]autorelease];
	...
	UIView* customHeaderView = [[[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 80-45)]autorelease];
...
//국가 코드 및 국가명 필드 추가. 2010.10.24
	...
	// TODO: [modify] 설치된 단말의 location 정보 사용하여 기본값 설정하도록 수정 필요.
